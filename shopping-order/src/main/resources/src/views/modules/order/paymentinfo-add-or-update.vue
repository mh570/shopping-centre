<template>
  <el-dialog
    ...
    <el-form-item label="֧" prop="alipayTradeNo">
      <el-input v-model="dataForm.alipayTradeNo" placeholder="֧"></el-input>
    </el-form-item>
    <el-form-item label="֧" prop="totalAmount">
      <el-input v-model="dataForm.totalAmount" placeholder="֧"></el-input>
    </el-form-item>
    <el-form-item label="" prop="subject">
      <el-input v-model="dataForm.subject" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="֧" prop="paymentStatus">
      <el-input v-model="dataForm.paymentStatus" placeholder="֧"></el-input>
    </el-form-item>
    <el-form-item label="" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder=""></el-input>
    </el-form-item>
    <el-form-item label="ȷ" prop="confirmTime">
      <el-input v-model="dataForm.confirmTime" placeholder="ȷ"></el-input>
    </el-form-item>
